...
('Pedro', '25/04/2002', 'Engenharia Civil'),
('João', '04/04/1972', 'Pedagogia'),
('Daiane', '12/08/2002', 'Ciências Biológicas'),
('Daniele', '20/04/2002', 'História'),
('Mateus', '02/08/2001', 'Engenharia Aeroespacial'),
('Rian Dziuba', '12/01/2001', 'Ciência da Computação'),
('Anne', '28/03/1988', 'Matemática'),
('Marcela', '20/05/1970', 'Administração'),
('Lucas', '02/03/2012', 'Gastronomia'),
('Bruno', '21/06/1997', 'Ciências Contábeis');
