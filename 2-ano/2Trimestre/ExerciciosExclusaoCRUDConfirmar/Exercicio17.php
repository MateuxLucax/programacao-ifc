...
<body>
   ...
   <!-- Cabeçalho -->
            ...
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="numero_praticantes" <?php echo $select == 'numero_praticantes' ? 'selected ' : ' '; ?>>Número de Praticantes</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' || $select == 'nenhum' || $select == 'numero_praticantes') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                                    $pesquisa = ' where '. $select.' = '. $pesquisa. ' order by '.$select;
                                }
                                $sql = 'select * from '. $tb_esporte. $pesquisa;
                            } elseif ($select == 'nome') {
                                $sql = 'select * from '. $tb_esporte. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['numero_praticantes']; ?></td>
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_esporte; ?>&url=Exercicio17')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio16.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio17.php">17</a></li>
