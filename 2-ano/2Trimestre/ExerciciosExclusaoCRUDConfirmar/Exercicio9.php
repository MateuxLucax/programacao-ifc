...
<head>
    ...
    <title>Exclusão CRUD | Exercício 9</title>
...
<body>
   ...
   <!-- Cabeçalho -->
            ...
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="anoDeFabricacao" <?php echo $select == 'anoDeFabricacao' ? 'selected ' : ' '; ?>>Ano de Fabricação</option>
                                <option value="dataDeVenda" <?php echo $select == 'dataDeVenda' ? 'selected ' : ' '; ?>>Data de Venda</option>
                                <option value="valor" <?php echo $select == 'valor' ? 'selected ' : ' '; ?>>Valor</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' or $select == 'nenhum' || $select == 'dataDeVenda' || $select == 'anoDeFabricacao') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                                ...
                                $sql = 'select * from '. $tb_carro. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            $resultado = mysqli_query($conexao, $sql);
                            while ($row = mysqli_fetch_array($resultado)) { ?>
                            <tr>
                                <td><?php echo $row['codigo']; ?></td>
                                <td><?php echo $row['anoDeFabricacao']; ?></td>
                                <td><?php echo $row['dataDeVenda']; ?></td>
                                <td><?php echo $row['valor']; ?></td>
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_carro; ?>&url=Exercicio9')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio8.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio9.php">9</a></li>
        ...
        <li class="waves-effect"><a href="Exercicio10.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
