...
<body>
   ...
   <!-- Cabeçalho -->
            ...
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="origem" <?php echo $select == 'origem' ? 'selected ' : ' '; ?>>Origem</option>
                                <option value="destino" <?php echo $select == 'destino' ? 'selected ' : ' '; ?>>Destino</option>
                                <option value="assunto" <?php echo $select == 'assunto' ? 'selected ' : ' '; ?>>Assunto</option>
                                <option value="data_envio" <?php echo $select == 'data_envio' ? 'selected ' : ' '; ?>>Data de Envio</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' || $select == 'nenhum' || $select == 'data_envio') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                            ...
                            } elseif ($select == 'destino' || $select == 'origem' || $select == 'assunto') {
                                $sql = 'select * from '. $tb_email. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_email; ?>&url=Exercicio15')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio14.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio15.php">15</a></li>
        <li><a href="Exercicio16.php">16</a></li>
        <li><a href="Exercicio17.php">17</a></li>
        <li class="waves-effect"><a href="Exercicio16.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
