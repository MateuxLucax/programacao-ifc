...
<head>
    ...
    <title>Exclusão CRUD | Exercício 1</title>
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">    
                            <select name="select">
                                ...
                                <option value="sigla" <?php echo $select == 'email' ? 'selected ' : ' '; ?>>Sigla</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            ...
                            } elseif ($select == 'nome' || $select == 'sigla') {
                                $sql = 'select * from '. $tb_estado. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_estado; ?>&url=Exercicio1')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
