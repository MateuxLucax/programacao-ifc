...
<body>
   ...
   <!-- Cabeçalho -->
    ...
    <!-- Conteúdo -->
    <main>
        <h3 class="center">Computadores</h3>
        <div class="container">
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="processador" <?php echo $select == 'processador' ? 'selected ' : ' '; ?>>Processador</option>
                                <option value="memoria" <?php echo $select == 'memoria' ? 'selected ' : ' '; ?>>Memória</option>
                                <option value="hd" <?php echo $select == 'hd' ? 'selected ' : ' '; ?>>HD</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' || $select == 'nenhum' || $select == 'memoria' || $select == 'hd') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                            ...
                            } elseif ($select == 'fabricante' || $select == 'processador') {
                                $sql = 'select * from '. $tb_computador. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_computador; ?>&url=Exercicio12')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio11.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio12.php">12</a></li>
        ...
        <li class="waves-effect"><a href="Exercicio13.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
