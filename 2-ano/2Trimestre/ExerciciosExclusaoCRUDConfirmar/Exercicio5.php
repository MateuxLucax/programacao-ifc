...
<head>
    ...
    <title>Exclusão CRUD | Exercício 5</title>
...
<body>
   ...
   <!-- Cabeçalho -->
    ...
    <!-- Conteúdo -->
    <main>
        <h3 class="center">Times de Futebol</h3>
        <div class="container">
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">    
                            <select name="select">
                                ...
                                <option value="numero_torcedores" <?php echo $select == 'numero_torcedores' ? 'selected ' : ' '; ?>>Número de Torcedores</option>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' or $select == 'nenhum' || $select == 'numero_torcedores') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                            ...
                            } elseif ($select == 'nome' || $select == 'cidade') {
                                $sql = 'select * from '. $tb_Time_futebol. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['numero_torcedores']; ?></td>
                                <td><?php echo $row['cidade']; ?></td>
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_Time_futebol; ?>&url=Exercicio5')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio4.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio5.php">5</a></li>
        ...
        <li class="waves-effect"><a href="Exercicio6.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
