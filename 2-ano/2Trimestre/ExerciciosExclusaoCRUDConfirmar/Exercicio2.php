...
<head>
    ...
    <title>Exclusão CRUD | Exercício 2</title>
                    ...
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            ...
                            if ($select == 'codigo' or $select == 'nenhum') {
                                ...
                                $sql = 'select * from '. $tb_cliente. $pesquisa;
                            } elseif ($select == 'nome' || $select == 'email' || $select == 'telefone') {
                                $sql = 'select * from '. $tb_cliente. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_cliente; ?>&url=Exercicio2')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
