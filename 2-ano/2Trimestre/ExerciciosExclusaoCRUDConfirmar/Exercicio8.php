...
<head>
    ...
    <title>Exclusão CRUD | Exercício 8</title>
...
<body>
   ...
   <!-- Cabeçalho -->
            ...
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="salario" <?php echo $select == 'salario' ? 'selected ' : ' '; ?>>Salário</option>
                                <option value="dataDeAdmissao" <?php echo $select == 'dataDeAdmissao' ? 'selected ' : ' '; ?>>Data de Admissão</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' or $select == 'nenhum' || $select == 'dataDeAdmissao') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                            ...
                            } elseif ($select == 'nome' || $select == 'salario') {
                                $sql = 'select * from '. $tb_funcionario. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_funcionario; ?>&url=Exercicio8')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio7.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio8.php">8</a></li>
        ...
        <li class="waves-effect"><a href="Exercicio9.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
