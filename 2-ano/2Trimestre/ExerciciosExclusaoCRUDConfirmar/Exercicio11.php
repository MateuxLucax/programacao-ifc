...
<body>
   ...
   <!-- Cabeçalho -->
            ...
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="anoDeLancamento" <?php echo $select == 'anoDeLancamento' ? 'selected ' : ' '; ?>>Ano de Lançamento</option>
                                <option value="classificacao" <?php echo $select == 'classificacao' ? 'selected ' : ' '; ?>>Classificação</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' or $select == 'nenhum' || $select == 'anoDeLancamento') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                            ...
                            } elseif ($select == 'classificacao') {
                                $sql = 'select * from '. $tb_jogo. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            $resultado = mysqli_query($conexao, $sql);
                            while ($row = mysqli_fetch_array($resultado)) { ?>
                            <tr>
                                <td><?php echo $row['codigo']; ?></td>
                                <td><?php echo $row['anoDeLancamento']; ?></td>
                                <td><?php echo $row['classificacao']; ?></td>
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_jogo; ?>&url=Exercicio11')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio10.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio11.php">11</a></li>
        ...
        <li class="waves-effect"><a href="Exercicio12.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
