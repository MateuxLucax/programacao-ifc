...
<head>
    ...
    <title>Exclusão CRUD | Exercício 6</title>
...
<body>
   ...
   <!-- Cabeçalho -->
                    ...
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_Time_futebol; ?>&url=Exercicio6')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio5.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio6.php">6</a></li>
        ...
        <li class="waves-effect"><a href="Exercicio7.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
