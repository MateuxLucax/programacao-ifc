...
<head>
    ...
    <title>Exclusão CRUD | Exercício 10</title>
...
<body>
   ...
   <!-- Cabeçalho -->
            ...
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="dataAtual" <?php echo $select == 'dataAtual' ? 'selected ' : ' '; ?>>Data Atual</option>
                                <option value="nivelDoRio" <?php echo $select == 'nivelDoRio' ? 'selected ' : ' '; ?>>Nível do Rio</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' or $select == 'nenhum' || $select == 'dataAtual') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                            ...
                            } elseif ($select == 'nivelDoRio') {
                                $sql = 'select * from '. $tb_enchente. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            $resultado = mysqli_query($conexao, $sql);
                            while ($row = mysqli_fetch_array($resultado)) { ?>
                            <tr>
                                <td><?php echo $row['codigo']; ?></td>
                                <td><?php echo $row['dataAtual']; ?></td>
                                <td><?php echo $row['nivelDoRio']; ?></td>
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_enchente; ?>&url=Exercicio10')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio9.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio10.php">10</a></li>
        ...
        <li class="waves-effect"><a href="Exercicio11.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
