...
<body>
   ...
   <!-- Cabeçalho -->
            ...
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="fabricante" <?php echo $select == 'fabricante' ? 'selected ' : ' '; ?>>Fabricante</option>
                                <option value="numero_marchas" <?php echo $select == 'numero_marchas' ? 'selected ' : ' '; ?>>Número de Marchas</option>
                                <option value="formacao_quadro" <?php echo $select == 'formacao_quadro' ? 'selected ' : ' '; ?>>Formação do Quadro</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' || $select == 'nenhum' || $select == 'numero_marchas') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                            ...
                            } elseif ($select == 'fabricante' || $select == 'formacao_quadro') {
                                $sql = 'select * from '. $tb_bicicleta. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['numero_marchas']; ?></td>
                                <td><?php echo $row['formacao_quadro']; ?></td>
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_bicicleta; ?>&url=Exercicio14')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio13.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li><a href="Exercicio13.php">13</a></li>
        <li class="active teal"><a href="Exercicio14.php">14</a></li>
        <li><a href="Exercicio15.php">15</a></li>
        <li><a href="Exercicio16.php">16</a></li>
        <li><a href="Exercicio17.php">17</a></li>
        <li class="waves-effect"><a href="Exercicio15.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
