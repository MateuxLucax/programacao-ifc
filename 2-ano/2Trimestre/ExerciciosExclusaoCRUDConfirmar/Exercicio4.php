...
<head>
    ...
    <title>Exclusão CRUD | Exercício 4</title>
...
<body>
   ...
   <!-- Cabeçalho -->
            ...
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">    
                            <select name="select">
                                ...
                                <option value="timeFutebol" <?php echo $select == 'timeFutebol' ? 'selected ' : ' '; ?>>Time de Futebol</option>
                                <option value="posicao" <?php echo $select == 'posicao' ? 'selected ' : ' '; ?>>Posição</option>
                                <option value="numeroGols" <?php echo $select == 'numeroGols' ? 'selected ' : ' '; ?>>Número de Gols</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' or $select == 'nenhum' || $select == 'numeroGols') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                            ...
                            } elseif ($select == 'posicao' || $select == 'nome' || $select == 'timeFutebol') {
                                $sql = 'select * from '. $tb_jogador. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['timeFutebol']; ?></td>
                                <td><?php echo $row['posicao']; ?></td>
                                <td><?php echo $row['numeroGols']; ?></td>
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_jogador; ?>&url=Exercicio4')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio3.php"><i class="material-icons">chevron_left</i></a></li>
        <li><a href="Exercicio1.php">1</a></li>
        <li><a href="Exercicio2.php">2</a></li>
        <li><a href="Exercicio3.php">3</a></li>
        <li class="active teal"><a href="Exercicio4.php">4</a></li>
        ...
        <li class="waves-effect"><a href="Exercicio5.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
