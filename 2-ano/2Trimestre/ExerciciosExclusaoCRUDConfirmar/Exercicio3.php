...
<head>
    ...
    <title>Exclusão CRUD | Exercício 3</title>
...
<body>
   ...
   <!-- Cabeçalho -->
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">    
                            <select name="select">
                                ...
                                <option value="login" <?php echo $select == 'login' ? 'selected ' : ' '; ?>>Login</option>
                                <option value="senha" <?php echo $select == 'senha' ? 'selected ' : ' '; ?>>Senha</option>
                                <option value="nome" <?php echo $select == 'nome' ? 'selected ' : ' '; ?>>Nome</option>
                                <option value="email" <?php echo $select == 'email' ? 'selected ' : ' '; ?>>E-Mail</option>
                                <option value="telefone" <?php echo $select == 'telefone' ? 'selected ' : ' '; ?>>Telefone</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            ...
                            } elseif ($select == 'nome' || $select == 'login' || $select == 'senha' || $select == 'telefone' || $select == 'email') {
                                $sql = 'select * from '. $tb_vendedor. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_vendedor; ?>&url=Exercicio3')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        ...
        <li class="waves-effect"><a href="Exercicio4.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
