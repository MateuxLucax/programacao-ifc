...
<body>
   ...
   <!-- Cabeçalho -->
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="cidade" <?php echo $select == 'cidade' ? 'selected ' : ' '; ?>>Cidade</option>
                                <option value="numero_alunos" <?php echo $select == 'numero_alunos' ? 'selected ' : ' '; ?>>Número de Alunos</option>
                                <option value="nome_diretora" <?php echo $select == 'nome_diretora' ? 'selected ' : ' '; ?>>Nome da Diretora</option>
                            </select>
                    ...
                    <table class="responsive-table highlight centered">
                        <thead>
                            <tr>
                                ...
                                <th>Nome da Diretora</th>
                                <th>Exclusão</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if ($select == 'codigo' || $select == 'nenhum' || $select == 'numero_alunos') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                            ...
                            } elseif ($select == 'nome' || $select == 'cidade' || $select == 'nome_diretora') {
                                $sql = 'select * from '. $tb_escola. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['numero_alunos']; ?></td>
                                <td><?php echo $row['nome_diretora']; ?></td>
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_escola; ?>&url=Exercicio16')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio15.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio16.php">16</a></li>
        <li><a href="Exercicio17.php">17</a></li>
        <li class="waves-effect"><a href="Exercicio17.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
