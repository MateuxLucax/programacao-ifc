...
<head>
    ...
    <title>Exclusão CRUD | Exercício 7</title>
...
<body>
   ...
   <!-- Cabeçalho -->
            ...
            <div class="row">
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class="input-field">
                            <select name="select">
                                ...
                                <option value="data_nascimento" <?php echo $select == 'data_nascimento' ? 'selected ' : ' '; ?>>Data de Nascimento</option>
                                <option value="curso" <?php echo $select == 'curso' ? 'selected ' : ' '; ?>>Curso</option>
                            </select>
                ...
                <div class="col s12 m8">
                    <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                            <?php
                            if ($select == 'codigo' or $select == 'nenhum') {
                                if ($pesquisa == '') {
                                    $pesquisa = '';
                                } else {
                                    $pesquisa = ' where '. $select.' = '. $pesquisa. ' order by '.$select;
                                }
                                $sql = 'select * from '. $tb_aluno. $pesquisa;
                            } elseif ($select == 'nome' || $select == 'data_nascimento' || $select == 'curso') {
                                $sql = 'select * from '. $tb_aluno. ' where '. $select.' like "'. $pesquisa. '%" order by '.$select;
                            }
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:excluirRegistro('exclusao.php?acao=excluir&codigo=<?php echo $row['codigo']; ?>&tabela=<?php echo $tb_aluno; ?>&url=Exercicio7')"><i class="material-icons teal-text">delete</i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <ul class="pagination center">
        <li class="waves-effect"><a href="Exercicio6.php"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li class="active teal"><a href="Exercicio7.php">7</a></li>
        ...
        <li class="waves-effect"><a href="Exercicio8.php"><i class="material-icons">chevron_right</i></a></li>
    </ul>
