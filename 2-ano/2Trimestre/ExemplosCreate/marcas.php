            ...
            <nav class="navbar navbar-expand-lg bg-primary text-primary fixed-top navbar-color-on-scroll" color-on-scroll="300">
                <div class="container">
                    <div class="navbar-translate">
                        <a class="navbar-brand" href="marcas.php" style="text-transform: uppercase;">
                            <?php echo $titulo; ?>
                        </a>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="descricao" <?php echo $filtro == 'descricao' ? 'selected ' : ''; ?>>Descrição</option>
                                                </select>
                                            </div>
