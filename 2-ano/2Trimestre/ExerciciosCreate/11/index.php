                            ...
                            <table class="table table-striped table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo converterData($tupla['anoDeLancamento']); ?>
                                        </td>
                                        <td>
                                            ...
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="codigo" <?php echo $filtro == 'codigo' ? 'selected ' : ''; ?>>Código</option>
                                                      <option value="anoDeLancamento" <?php echo $filtro == 'anoDeLancamento' ? 'selected ' : ''; ?>>Ano de lançamento</option>
