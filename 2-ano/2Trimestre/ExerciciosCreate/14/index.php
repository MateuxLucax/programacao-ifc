...
<?php
  ...
  if ($filtro == 'codigo' || $filtro == 'nenhum' || $filtro == 'numero_marchas') {
    if ($pesquisa != '') { $aux = ' where '. $filtro.' = '. $pesquisa. ' order by '.$filtro; }
    $sql = 'select * from '. $tabela. $aux;
  } elseif ($filtro == 'formacao_quadro' || $filtro == 'fabricante') {
                            ...
                            <table class="table table-striped table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">Número de marchas</th>
                                        <th class="text-center" scope="col">Formação do quadro</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $tupla['numero_marchas']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['formacao_quadro']; ?>
                                        </td>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="numero_marchas" <?php echo $filtro == 'numero_marchas' ? 'selected ' : ''; ?>>Número de marchas</option>
                                                    <option value="formacao_quadro" <?php echo $filtro == 'formacao_quadro' ? 'selected ' : ''; ?>>Formação do quadro</option>
                                                </select>
                                            </div>
