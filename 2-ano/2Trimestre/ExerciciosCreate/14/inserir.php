            ...
            <div class="card card-login card-plain">
              <form class="form" method="get" action="assets/funcoes/acao.php" style="margin-top: 50%;">
                <div class="card-body">
                    ...
                    <div class="input-group">
                      <input type="number" class="form-control" name="numero_marchas" placeholder="Número de marchas">
                      <span class="input-group-addon"><i class="now-ui-icons design_app"></i></span>
                    </div>
                    <div class="input-group">
                      <input type="text" class="form-control" name="formacao_quadro" placeholder="Formação do quadro">
                      <span class="input-group-addon"><i class="now-ui-icons design_app"></i></span>
                    </div>
