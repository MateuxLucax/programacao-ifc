                            ...
                            <table class="table table-striped table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">Data atual</th>
                                        <th class="text-center" scope="col">Nível do rio</th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="codigo" <?php echo $filtro == 'codigo' ? 'selected ' : ''; ?>>Código</option>
                                                      <option value="dataAtual" <?php echo $filtro == 'dataAtual' ? 'selected ' : ''; ?>>Data atual</option>
                                                    <option value="nivelDoRio" <?php echo $filtro == 'nivelDoRio' ? 'selected ' : ''; ?>>Nível do rio</option>
                                                </select>
                                            </div>
