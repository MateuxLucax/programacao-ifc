...
<?php
  ...
  if ($filtro == 'codigo' || $filtro == 'nenhum' || $filtro == 'numeroGols') {
    if ($pesquisa != '') { $aux = ' where '. $filtro.' = '. $pesquisa. ' order by '.$filtro; }
    $sql = 'select * from '. $tabela. $aux;
  } elseif ($filtro == 'nome' || $filtro == 'timeFutebol' || $filtro == 'posicao') {
                            ...
                            <table class="table table-striped table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">Time de Futebol</th>
                                        <th class="text-center" scope="col">Posição</th>
                                        <th class="text-center" scope="col">Número de Gols</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="timeFutebol" <?php echo $filtro == 'timeFutebol' ? 'selected ' : ''; ?>>Time de Futebol</option>
                                                    <option value="posicao" <?php echo $filtro == 'posicao' ? 'selected ' : ''; ?>>Posição</option>
                                                    <option value="numeroGols" <?php echo $filtro == 'numeroGols' ? 'selected ' : ''; ?>>Número de Gols</option>
                                                </select>
                                            </div>
