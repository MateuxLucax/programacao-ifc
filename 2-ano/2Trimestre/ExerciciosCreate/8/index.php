...
<?php
  ...
  if ($filtro == 'codigo' || $filtro == 'nenhum' || $filtro == 'salario') {
                            ...
                            <table class="table table-striped table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">Salário</th>
                                        <th class="text-center" scope="col">Data de Admissão</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>R$
                                            <?php echo $tupla['salario']; ?>
                                        </td>
                                        <td>
                                          <?php echo converterData($tupla['dataDeAdmissao']); ?>
                                        </td>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="dataDeAdmissao" <?php echo $filtro == 'dataDeAdmissao' ? 'selected ' : ''; ?>>Data de Admissão</option>
                                                </select>
                                            </div>
