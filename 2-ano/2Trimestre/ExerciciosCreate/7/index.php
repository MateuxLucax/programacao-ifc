                            ...
                            <table class="table table-striped table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo converterData($tupla['data_nascimento']); ?>
                                        </td>
                                        <td>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="data_nascimento" <?php echo $filtro == 'data_nascimento' ? 'selected ' : ''; ?>>Data de Nascimento</option>
