...
<?php
  ...
  if ($filtro == 'codigo' || $filtro == 'nenhum' || $filtro == 'numero_salas' || $filtro == 'numero_andares') {
                            ...
                            <table class="table table-striped table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">Número de salas</th>
                                        <th class="text-center" scope="col">Número de andares</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $tupla['numero_salas']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['numero_andares']; ?>
                                        </td>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="numero_salas" <?php echo $filtro == 'numero_salas' ? 'selected ' : ''; ?>>Número de salas</option>
                                                    <option value="numero_andares" <?php echo $filtro == 'numero_andares' ? 'selected ' : ''; ?>>Número de andares</option>
                                                </select>
                                            </div>
