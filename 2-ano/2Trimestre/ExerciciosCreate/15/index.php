...
<?php
  ...
  } elseif ($filtro == 'assunto' || $filtro == 'origem' || $filtro == 'destino') {
    $sql = 'select * from '. $tabela. ' where '. $filtro.' like "'. $pesquisa. '%" order by '.$filtro;
  } elseif ($filtro == 'data_envio'){
                            ...
                            <table class="table table-striped table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">Assunto</th>
                                        <th class="text-center" scope="col">Data de envio</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <?php echo $tupla['origem']; ?>
                                        </td>
                                        <td>
                                          <?php echo $tupla['destino']; ?>
                                        </td>
                                        <td>
                                          <?php echo $tupla['assunto']; ?>
                                        </td>
                                        <td>
                                            <?php echo converterData($tupla['dataAtual']); ?>
                                        </td>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="assunto" <?php echo $filtro == 'assunto' ? 'selected ' : ''; ?>>Assunto</option>
                                                    <option value="data_envio" <?php echo $filtro == 'data_envio' ? 'selected ' : ''; ?>>Data de envio</option>
                                                </select>
                                            </div>
