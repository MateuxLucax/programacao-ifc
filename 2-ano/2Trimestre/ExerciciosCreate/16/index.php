...
<?php
  ...
  if ($filtro == 'codigo' || $filtro == 'nenhum' || $filtro == 'numero_alunos') {
    if ($pesquisa != '') { $aux = ' where '. $filtro.' = '. $pesquisa. ' order by '.$filtro; }
    $sql = 'select * from '. $tabela. $aux;
  } elseif ($filtro == 'nome' || $filtro == 'cidade' || $filtro == 'nome_diretora') {
                            ...
                            <table class="table table-striped table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">Número de alunos</th>
                                        <th class="text-center" scope="col">Nome do(a) diretor(a)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $tupla['numero_alunos']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['nome_diretora']; ?>
                                        </td>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="cidade" <?php echo $filtro == 'cidade' ? 'selected ' : ''; ?>>Cidade</option>
                                                    <option value="numero_alunos" <?php echo $filtro == 'numero_alunos' ? 'selected ' : ''; ?>>Número de alunos</option>
                                                    <option value="nome_diretora" <?php echo $filtro == 'nome_diretora' ? 'selected ' : ''; ?>>Nome do(a) diretor(a)</option>
                                                </select>
                                            </div>
