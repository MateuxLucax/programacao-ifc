...
<?php
  ...
  if ($filtro == 'codigo' || $filtro == 'nenhum' || $filtro == 'numero_praticantes') {
                            ...
                            <table class="table table-striped table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">Número de praticantes</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $tupla['numero_praticantes']; ?>
                                        </td>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="numero_praticantes" <?php echo $filtro == 'numero_praticantes' ? 'selected ' : ''; ?>>Número de praticantes</option>
                                                </select>
                                            </div>
