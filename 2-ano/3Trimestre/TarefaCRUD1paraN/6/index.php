...
<?php
  ...
  } elseif ($filtro == 'nome' || $filtro == 'sigla' || $filtro == 'continente') {
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col m6 s12 l4">
                                <select name="filtro">
                                    ...
                                    <option value="continente" <?php echo $filtro == 'continente' ? 'selected ' : '' ; ?>>Continente</option>
                                </select>
                                <label>Filtrar</label>
                            </div>
                                              ...
                                              <div class="modal-content">
                                                  <center>
                                                      ...
                                                      <form action="acao.php" method="post">
                                                          ...
                                                          <div class="input-field col s12">
                                                              <input id="continente" type="text" name="continente" value="<?php echo $tupla['continente'] ?>" />
                                            ...
                                            <div class="modal-content">
                                                <center>
                                                    ...
                                                    <form action="acao.php" method="post">
                                                        ...
                                                        <div class="input-field col s12">
                                                            <input id="continente" type="text" name="continente" />
                                                            <label for="continente">Continente</label>
                                                        </div>
                                                        <center>
                                                            <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
