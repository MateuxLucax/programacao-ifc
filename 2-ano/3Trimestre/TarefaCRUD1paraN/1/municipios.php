...
<?php
  ...
  include 'funcoes.php';
  $titulo = 'Municípios';
  $link = 'municipios.php#tabela';
  $tabela = $GLOBAL['tbMunicipios'];
  $pesquisa = isset($_POST['pesquisa'])?$_POST['pesquisa']:'';
  $filtro = isset($_POST['filtro'])?$_POST['filtro']:'nenhum';
  if ($filtro == 'codigoMunicipio' || $filtro == 'nenhum') {
    $aux = '';
...
<body>
    ...
    <header>
        <ul id="nav-mobile" class="sidenav">
            <li><a href="index.php">Estados</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col m6 s12 l4">
                                <select name="filtro">
                                    ...
                                    <option value="codigoMunicipio" <?php echo $filtro == 'codigoMunicipio' ? 'selected ' : '' ; ?>>Código</option>
                                    <option value="nome" <?php echo $filtro == 'nome' ? 'selected ' : '' ; ?>>Nome</option>
                                    <option value="sigla" <?php echo $filtro == 'sigla' ? 'selected ' : '' ; ?>>Sigla</option>
                                </select>
                                <label>Filtrar</label>
                            </div>
                        ...
                        <div class="input-field col s12">
                            <table class="striped responsive-table centered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo $tupla['codigoMunicipio']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['nome']; ?>
                                        </td>
                                        <td>
                                            <?php Query1paraN($GLOBAL['tbEstado'], 'codigo', $tupla['estado']) ?>
                                        </td>
                                        <!-- Alterar -->
                                        <td>
                                          <a class="waves-effect waves-light modal-trigger green-text" href="#alterar<?php echo $tupla['codigoMunicipio'] ;?>"><i class="material-icons">build</i></a>
                                          <div id="alterar<?php echo $tupla['codigoMunicipio'] ;?>" class="modal">
                                              <div class="modal-content">
                                                  <center>
                                                      ...
                                                      <form action="acao.php" method="post">
                                                          ...
                                                          <div class="input-field col s12">
                                                            <?php geradorSelect($GLOBAL['tbEstado'], $tupla['estado'], 'codigo', 'nome', 'estado') ?>
                                                          </div>
                                                          <center>
                                                              <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
                                                              <input type="hidden" name="link" value="<?php echo $link; ?>">
                                                              <input type="hidden" name="codigoMunicipio" value="<?php echo $tupla['codigoMunicipio']; ?>">
                                        ...
                                        <!-- Excluir -->
                                        <td>
                                            <a class="waves-effect waves-light modal-trigger red-text" href="#excluir<?php echo $tupla['codigoMunicipio']; ?>"><i class="material-icons">clear</i></a>
                                            <div id="excluir<?php echo $tupla['codigoMunicipio']; ?>" class="modal" style="width: 350px;">
                                                <div class="modal-content">
                                                    <center>
                                                        <h4>Confirmar Exclusão!</h4>
                                                        <p>Deseja realmente excluir esse registro?<br />Essa operação não poderá ser desefeita</p>
                                                        <a href="#!" class="modal-action modal-close waves-effect waves-red btn-flat">Cancelar</a>
                                                        <a href="acao.php?acao=excluir&codigo=<?php echo $tupla['codigoMunicipio']; ?>&tabela=<?php echo $tabela; ?>&link=<?php echo $link; ?>" class="modal-action waves-effect waves-teal btn-flat">Confirmar</a>
                                                    </center>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="modal-content">
                                                <center>
                                                    ...
                                                    <form action="acao.php" method="post">
                                                        ...
                                                        <div class="input-field col s12">
                                                          <?php geradorSelect($GLOBAL['tbEstado'], '1', 'codigo', 'nome', 'estado') ?>
                                                        </div>
                                                        <center>
                                                            <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
                                                            <input type="hidden" name="link" value="<?php echo $link; ?>">
