                        ...
                        <div class="row">
                            ...
                            <div class="input-field col m6 s12 l4">
                                <select name="filtro">
                                    ...
                                    <option value="codigoVenda" <?php echo $filtro == 'codigoVenda' ? 'selected ' : '' ; ?>>Código</option>
                                    <option value="valor" <?php echo $filtro == 'valor' ? 'selected ' : '' ; ?>>Valor</option>
                                    <option value="vendedor" <?php echo $filtro == 'vendedor' ? 'selected ' : '' ; ?>>Vendedor</option>
                                </select>
                                <label>Filtrar</label>
                            </div>
                        ...
                        <div class="input-field col s12">
                            <table class="striped responsive-table centered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo $tupla['codigoVenda']; ?>
                                        </td>
                                        <td>R$
                                            <?php echo number_format($tupla['valor'], 2, ',', '.'); ?>
                                        </td>
                                        <td>
                                            <?php Query1paraN($GLOBAL['tbVendedor'], 'codigo', $tupla['vendedor']) ?>
                                        </td>
                                        <!-- Alterar -->
                                        <td>
                                          <a class="waves-effect waves-light modal-trigger green-text" href="#alterar<?php echo $tupla['codigoVenda'] ;?>"><i class="material-icons">build</i></a>
                                          <div id="alterar<?php echo $tupla['codigoVenda'] ;?>" class="modal">
                                              <div class="modal-content">
                                                  <center>
                                                      ...
                                                      <form action="acao.php" method="post">
                                                          ...
                                                          <div class="input-field col s12">
                                                            <?php geradorSelect($GLOBAL['tbVendedor'], $tupla['vendedor'], 'codigo', 'nome', 'vendedor') ?>
                                                          </div>
                                                          <center>
                                                              <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
                                                              <input type="hidden" name="link" value="<?php echo $link; ?>">
                                                              <input type="hidden" name="codigoVenda" value="<?php echo $tupla['codigoVenda']; ?>">
                                        ...
                                        <!-- Excluir -->
                                        <td>
                                            <a class="waves-effect waves-light modal-trigger red-text" href="#excluir<?php echo $tupla['codigoVenda']; ?>"><i class="material-icons">clear</i></a>
                                            <div id="excluir<?php echo $tupla['codigoVenda']; ?>" class="modal" style="width: 350px;">
                                                <div class="modal-content">
                                                    <center>
                                                        <h4>Confirmar Exclusão!</h4>
                                                        <p>Deseja realmente excluir esse registro?<br />Essa operação não poderá ser desefeita</p>
                                                        <a href="#!" class="modal-action modal-close waves-effect waves-red btn-flat">Cancelar</a>
                                                        <a href="acao.php?acao=excluir&codigo=<?php echo $tupla['codigoVenda']; ?>&tabela=<?php echo $tabela; ?>&link=<?php echo $link; ?>" class="modal-action waves-effect waves-teal btn-flat">Confirmar</a>
                                                    </center>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="modal-content">
                                                <center>
                                                    ...
                                                    <form action="acao.php" method="post">
                                                        ...
                                                        <div class="input-field col s12">
                                                          <?php geradorSelect($GLOBAL['tbVendedor'], '1', 'codigo', 'nome', 'vendedor') ?>
                                                        </div>
                                                        <center>
                                                            <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
                                                            <input type="hidden" name="link" value="<?php echo $link; ?>">
