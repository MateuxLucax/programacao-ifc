...
<?php
  ...
  include 'funcoes.php';
  $titulo = 'Clubes';
  $link = 'clube.php#tabela';
  $tabela = $GLOBAL['tbClube'];
  $pesquisa = isset($_POST['pesquisa'])?$_POST['pesquisa']:'';
  $filtro = isset($_POST['filtro'])?$_POST['filtro']:'nenhum';
  if ($filtro == 'codigoTime' || $filtro == 'nenhum') {
    $aux = '';
    if ($pesquisa != '') { $aux = ' where '. $filtro.' = '. $pesquisa. ' order by '.$filtro; }
    $sql = 'select * from '. $tabela. $aux;
  } elseif ($filtro == 'nome' || $filtro == 'numeroTorcedores' || $filtro == 'cidade') {
...
<body>
    ...
    <header>
        <ul id="nav-mobile" class="sidenav">
            <li><a href="index.php">Países de clubes</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col m6 s12 l4">
                                <select name="filtro">
                                    ...
                                    <option value="codigoTime" <?php echo $filtro == 'codigoTime' ? 'selected ' : '' ; ?>>Código</option>
                        ...
                        <div class="input-field col s12">
                            <table class="striped responsive-table centered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo $tupla['codigoTime']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['nome']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['numeroTorcedores']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['cidade']; ?>
                                        </td>
                                        <td>
                                            <?php Query1paraN($GLOBAL['tbPaisClube'], 'codigo', $tupla['pais']) ?>
                                        </td>
                                        <!-- Alterar -->
                                        <td>
                                          <a class="waves-effect waves-light modal-trigger green-text" href="#alterar<?php echo $tupla['codigoTime'] ;?>"><i class="material-icons">build</i></a>
                                          <div id="alterar<?php echo $tupla['codigoTime'] ;?>" class="modal">
                                              <div class="modal-content">
                                                  <center>
                                                      ...
                                                      <form action="acao.php" method="post">
                                                          ...
                                                          <div class="input-field col s12">
                                                              <input id="numeroTorcedores" type="number" name="numeroTorcedores" value="<?php echo $tupla['numeroTorcedores']; ?>" />
                                                              <label for="numeroTorcedores">Número de torcedores</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                              <input id="cidade" type="text" name="cidade" value="<?php echo $tupla['cidade']; ?>" />
                                                              <label for="cidade">Cidade</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                            <?php geradorSelect($GLOBAL['tbPaisClube'], $tupla['cidade'], 'codigo', 'nome', 'pais') ?>
                                                          </div>
                                                          <center>
                                                              <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
                                                              <input type="hidden" name="link" value="<?php echo $link; ?>">
                                                              <input type="hidden" name="codigoTime" value="<?php echo $tupla['codigoTime']; ?>">
                                        ...
                                        <!-- Excluir -->
                                        <td>
                                            <a class="waves-effect waves-light modal-trigger red-text" href="#excluir<?php echo $tupla['codigoTime']; ?>"><i class="material-icons">clear</i></a>
                                            <div id="excluir<?php echo $tupla['codigoTime']; ?>" class="modal" style="width: 350px;">
                                                <div class="modal-content">
                                                    <center>
                                                        <h4>Confirmar Exclusão!</h4>
                                                        <p>Deseja realmente excluir esse registro?<br />Essa operação não poderá ser desefeita</p>
                                                        <a href="#!" class="modal-action modal-close waves-effect waves-red btn-flat">Cancelar</a>
                                                        <a href="acao.php?acao=excluir&codigo=<?php echo $tupla['codigoTime']; ?>&tabela=<?php echo $tabela; ?>&link=<?php echo $link; ?>" class="modal-action waves-effect waves-teal btn-flat">Confirmar</a>
                                                    </center>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="modal-content">
                                                <center>
                                                    ...
                                                    <form action="acao.php" method="post">
                                                        ...
                                                        <div class="input-field col s12">
                                                            <input id="numeroTorcedores" type="number" name="numeroTorcedores" />
                                                            <label for="numeroTorcedores">Número de torcedores</label>
                                                        </div>
                                                        <div class="input-field col s12">
