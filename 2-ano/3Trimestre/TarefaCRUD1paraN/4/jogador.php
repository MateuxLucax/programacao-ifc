...
<body>
    ...
    <header>
        <ul id="nav-mobile" class="sidenav">
            <li><a href="index.php">Vendedores</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col m6 s12 l4">
                                <select name="filtro">
                                    ...
                                    <option value="codigoJogador" <?php echo $filtro == 'codigoJogador' ? 'selected ' : '' ; ?>>Código</option>
                                    <option value="nome" <?php echo $filtro == 'nome' ? 'selected ' : '' ; ?>>Nome</option>
                                    <option value="clube" <?php echo $filtro == 'clube' ? 'selected ' : '' ; ?>>Clube</option>
                                </select>
                                <label>Filtrar</label>
                            </div>
                        ...
                        <div class="input-field col s12">
                            <table class="striped responsive-table centered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo $tupla['codigoJogador']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['nome']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['clube']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['posicao']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['numeroGols']; ?>
                                        </td>
                                        <td>
                                            <?php Query1paraN($GLOBAL['tbEmpresario'], 'codigo', $tupla['empresario']) ?>
                                        </td>
                                        <!-- Alterar -->
                                        <td>
                                          <a class="waves-effect waves-light modal-trigger green-text" href="#alterar<?php echo $tupla['codigoJogador'] ;?>"><i class="material-icons">build</i></a>
                                          <div id="alterar<?php echo $tupla['codigoJogador'] ;?>" class="modal">
                                              <div class="modal-content">
                                                  <center>
                                                      ...
                                                      <form action="acao.php" method="post">
                                                          ...
                                                          <div class="input-field col s12">
                                                              <input id="clube" type="text" name="clube" value="<?php echo $tupla['clube']; ?>" />
                                                              <label for="clube">Clube</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                              <input id="posicao" type="text" name="posicao" value="<?php echo $tupla['posicao']; ?>" />
                                                              <label for="posicao">Posição</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                              <input id="numeroGols" type="number" name="numeroGols" value="<?php echo $tupla['numeroGols']; ?>" />
                                                              <label for="numeroGols">Número de gols</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                            <?php geradorSelect($GLOBAL['tbEmpresario'], $tupla['empresario'], 'codigo', 'nome', 'empresario') ?>
                                                          </div>
                                                          <center>
                                                              <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
                                                              <input type="hidden" name="link" value="<?php echo $link; ?>">
                                                              <input type="hidden" name="codigoJogador" value="<?php echo $tupla['codigoJogador']; ?>">
                                        ...
                                        <!-- Excluir -->
                                        <td>
                                            <a class="waves-effect waves-light modal-trigger red-text" href="#excluir<?php echo $tupla['codigoJogador']; ?>"><i class="material-icons">clear</i></a>
                                            <div id="excluir<?php echo $tupla['codigoJogador']; ?>" class="modal" style="width: 350px;">
                                                <div class="modal-content">
                                                    <center>
                                                        <h4>Confirmar Exclusão!</h4>
                                                        <p>Deseja realmente excluir esse registro?<br />Essa operação não poderá ser desefeita</p>
                                                        <a href="#!" class="modal-action modal-close waves-effect waves-red btn-flat">Cancelar</a>
                                                        <a href="acao.php?acao=excluir&codigo=<?php echo $tupla['codigoJogador']; ?>&tabela=<?php echo $tabela; ?>&link=<?php echo $link; ?>" class="modal-action waves-effect waves-teal btn-flat">Confirmar</a>
                                                    </center>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="modal-content">
                                                <center>
                                                    ...
                                                    <form action="acao.php" method="post">
                                                          ...
                                                          <div class="input-field col s12">
                                                              <input id="clube" type="text" name="clube" />
                                                              <label for="clube">Clube</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                          ...
                                                          <div class="input-field col s12">
                                                              <input id="numeroGols" type="number" name="numeroGols" />
                                                              <label for="numeroGols">Número de gols</label>
                                                          </div>
                                                        <div class="input-field col s12">
                                                          <?php geradorSelect($GLOBAL['tbEmpresario'], '1', 'codigo', 'nome', 'empresario') ?>
                                                        </div>
                                                        <center>
                                                            <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
                                                            <input type="hidden" name="link" value="<?php echo $link; ?>">
