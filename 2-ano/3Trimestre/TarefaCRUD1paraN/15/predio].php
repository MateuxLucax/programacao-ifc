                        ...
                        <div class="row">
                            ...
                            <div class="input-field col m6 s12 l4">
                                <select name="filtro">
                                    ...
                                    <option value="codigoEnchente" <?php echo $filtro == 'codigoEnchente' ? 'selected ' : '' ; ?>>Código</option>
                                    <option value="dataVenda" <?php echo $filtro == 'dataVenda' ? 'selected ' : '' ; ?>>Data</option>
                                    <option value="nivelRio" <?php echo $filtro == 'nivelRio' ? 'selected ' : '' ; ?>>Nível do rio</option>
                                </select>
                                <label>Filtrar</label>
                            </div>
                        ...
                        <div class="input-field col s12">
                            <table class="striped responsive-table centered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo $tupla['codigoEnchente']; ?>
                                        </td>
                                        <td>
                                          <?php echo converterData($tupla['data']);; ?>
                                        </td>
                                        <td>
                                          <?php echo $tupla['nivelRio']; ?>
                                        </td>
                                        <td>
                                            <?php Query1paraN($GLOBAL['tbCidade'], 'codigo', $tupla['cidade'], 'nome') ?>
                                        </td>
                                        <!-- Alterar -->
                                        <td>
                                          <a class="waves-effect waves-light modal-trigger green-text" href="#alterar<?php echo $tupla['codigoEnchente'] ;?>"><i class="material-icons">build</i></a>
                                          <div id="alterar<?php echo $tupla['codigoEnchente'] ;?>" class="modal">
                                              <div class="modal-content">
                                                  <center>
                                                      <h4>Alterar</h4>
                                                      <form action="acao.php" method="post">
                                                          <div class="input-field col s12">
                                                              <input id="data" type="text" name="data" value="<?php echo converterData($tupla['data']); ?>" />
                                                              <label for="data">Data</label>
                                                          </div>
                                                            <div class="input-field col s12">
                                                              <input id="nivelRio" type="number" step="0.01" name="nivelRio" value="<?php echo $tupla['nivelRio']; ?>" />
                                                              <label for="nivelRio">Nível do rio</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                            <?php geradorSelect($GLOBAL['tbCidade'], $tupla['cidade'], 'codigo', 'nome', 'cidade') ?>
                                                          </div>
                                                          <center>
                                                              <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
                                                              <input type="hidden" name="link" value="<?php echo $link; ?>">
                                                              <input type="hidden" name="codigoEnchente" value="<?php echo $tupla['codigoEnchente']; ?>">
                                        ...
                                        <!-- Excluir -->
                                        <td>
                                            <a class="waves-effect waves-light modal-trigger red-text" href="#excluir<?php echo $tupla['codigoEnchente']; ?>"><i class="material-icons">clear</i></a>
                                            <div id="excluir<?php echo $tupla['codigoEnchente']; ?>" class="modal" style="width: 350px;">
                                                <div class="modal-content">
                                                    <center>
                                                        <h4>Confirmar Exclusão!</h4>
                                                        <p>Deseja realmente excluir esse registro?<br />Essa operação não poderá ser desefeita</p>
                                                        <a href="#!" class="modal-action modal-close waves-effect waves-red btn-flat">Cancelar</a>
                                                        <a href="acao.php?acao=excluir&codigo=<?php echo $tupla['codigoEnchente']; ?>&tabela=<?php echo $tabela; ?>&link=<?php echo $link; ?>" class="modal-action waves-effect waves-teal btn-flat">Confirmar</a>
                                                    </center>
                                                </div>
                                            </div>
                                        </td>
                                                ...
                                                <center>
                                                    ...
                                                    <form action="acao.php" method="post">
                                                        <div class="input-field col s12">
                                                          ...
                                                          <div class="input-field col s12">
                                                            <input id="nivelRio" type="number" step="0.01" name="nivelRio" />
                                                            <label for="nivelRio">Nível do rio</label>
                                                        </div>
                                                        <div class="input-field col s12">
                                                          <?php geradorSelect($GLOBAL['tbCidade'], $tupla['cidade'], 'codigo', 'nome', 'cidade') ?>
