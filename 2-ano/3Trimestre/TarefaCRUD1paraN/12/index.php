...
<?php
  ...
  } elseif ($filtro == 'fabricante' || $filtro == 'processador' || $filtro == 'memoria' || $filtro == 'hd') {
...
<body>
    ...
    <header>
        <ul id="nav-mobile" class="sidenav">
            <li><a href="comprador.php">Compradores</a></li>
                                              ...
                                              <div class="modal-content">
                                                  <center>
                                                      ...
                                                      <form action="acao.php" method="post">
                                                          ...
                                                          <div class="input-field col s12">
                                                              <input id="processador" type="text" name="processador" value="<?php echo $tupla['processador'] ?>" />
                                                              <label for="processador">Processador</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                              <input id="memoria" type="text" name="memoria" value="<?php echo $tupla['memoria'] ?>" />
                                                              <label for="memoria">Memória</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                              <input id="hd" type="text" name="hd" value="<?php echo $tupla['hd'] ?>" />
                                            ...
                                            <div class="modal-content">
                                                <center>
                                                    ...
                                                    <form action="acao.php" method="post">
                                                        ...
                                                        <div class="input-field col s12">
                                                            <input id="processador" type="text" name="processador" />
                                                            <label for="processador">Processador</label>
                                                        </div>
                                                        <div class="input-field col s12">
                                                            <input id="memoria" type="text" name="memoria" />
                                                            <label for="memoria">Memória</label>
                                                        </div>
                                                        <div class="input-field col s12">
                                                            <input id="hd" type="text" name="hd" />
                                                            <label for="hd">HD</label>
                                                        </div>
                                                        <center>
                                                            <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
