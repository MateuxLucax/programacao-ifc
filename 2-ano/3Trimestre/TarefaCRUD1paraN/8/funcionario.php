...
<?php
  include 'funcoes.php';
  $titulo = 'Funcionários';
  $link = 'funcionario.php#tabela';
  $tabela = $GLOBAL['tbFuncionario'];
  $pesquisa = isset($_POST['pesquisa'])?$_POST['pesquisa']:'';
  $filtro = isset($_POST['filtro'])?$_POST['filtro']:'nenhum';
  if ($filtro == 'codigoFuncionario' || $filtro == 'nenhum') {
    $aux = '';
...
<body>
    ...
    <header>
        <ul id="nav-mobile" class="sidenav">
            <li><a href="index.php">Funções</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col m6 s12 l4">
                                <select name="filtro">
                                    ...
                                    <option value="codigoFuncionario" <?php echo $filtro == 'codigoFuncionario' ? 'selected ' : '' ; ?>>Código</option>
                                    <option value="nome" <?php echo $filtro == 'nome' ? 'selected ' : '' ; ?>>Nome</option>
                                    <option value="dataAdmissao" <?php echo $filtro == 'dataAdmissao' ? 'selected ' : '' ; ?>>Data de admissão</option>
                        ...
                        <div class="input-field col s12">
                            <table class="striped responsive-table centered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo $tupla['codigoFuncionario']; ?>
                                        </td>
                                        <td>
                                          <?php echo $tupla['nome']; ?>
                                        </td>
                                        ...
                                        <td>
                                          <?php echo converterData($tupla['dataAdmissao']); ?>
                                        </td>
                                        <td>
                                            <?php Query1paraN($GLOBAL['tbFuncao'], 'codigo', $tupla['funcao']) ?>
                                        </td>
                                        <!-- Alterar -->
                                        <td>
                                          <a class="waves-effect waves-light modal-trigger green-text" href="#alterar<?php echo $tupla['codigoFuncionario'] ;?>"><i class="material-icons">build</i></a>
                                          <div id="alterar<?php echo $tupla['codigoFuncionario'] ;?>" class="modal">
                                              <div class="modal-content">
                                                  <center>
                                                      ...
                                                      <form action="acao.php" method="post">
                                                          ...
                                                          <div class="input-field col s12">
                                                              <input id="dataAdmissao" type="text" name="dataAdmissao" value="<?php echo converterData($tupla['dataAdmissao']); ?>" />
                                                              <label for="dataAdmissao">Data de admissão</label>
                                                          </div>
                                                          <div class="input-field col s12">
                                                            <?php geradorSelect($GLOBAL['tbFuncao'], $tupla['funcao'], 'codigo', 'nome', 'funcao') ?>
                                                          </div>
                                                          <center>
                                                              <input type="hidden" name="tabela" value="<?php echo $tabela; ?>">
                                                              <input type="hidden" name="link" value="<?php echo $link; ?>">
                                                              <input type="hidden" name="codigoFuncionario" value="<?php echo $tupla['codigoFuncionario']; ?>">
                                        ...
                                        <!-- Excluir -->
                                        <td>
                                            <a class="waves-effect waves-light modal-trigger red-text" href="#excluir<?php echo $tupla['codigoFuncionario']; ?>"><i class="material-icons">clear</i></a>
                                            <div id="excluir<?php echo $tupla['codigoFuncionario']; ?>" class="modal" style="width: 350px;">
                                                <div class="modal-content">
                                                    <center>
                                                        <h4>Confirmar Exclusão!</h4>
                                                        <p>Deseja realmente excluir esse registro?<br />Essa operação não poderá ser desefeita</p>
                                                        <a href="#!" class="modal-action modal-close waves-effect waves-red btn-flat">Cancelar</a>
                                                        <a href="acao.php?acao=excluir&codigo=<?php echo $tupla['codigoFuncionario']; ?>&tabela=<?php echo $tabela; ?>&link=<?php echo $link; ?>" class="modal-action waves-effect waves-teal btn-flat">Confirmar</a>
                                                    </center>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="modal-content">
                                                <center>
                                                    ...
                                                    <form action="acao.php" method="post">
                                                        ...
                                                        <div class="input-field col s12">
                                                            <input id="dataAdmissao" type="text" name="dataAdmissao" />
                                                            <label for="dataAdmissao">Data de admissão</label>
                                                        </div>
                                                        <div class="input-field col s12">
                                                          <?php geradorSelect($GLOBAL['tbFuncao'], $tupla['funcao'], 'codigo', 'nome', 'funcao') ?>
