...
<?php
  ...
  if ($botao == 'buscaSimples') {
    ...
    } elseif ($filtro == 'origemEDestino') {
      $sql = "select * from ". $tabela. " where origem = '".$inicial. "' and destino = '". $final. "'";
    } elseif ($filtro == 'dataVoo') {
    ...
    } elseif ($filtro == 'valorPassagem') {
      $sql = 'select * from '. $tabela. ' where '. $filtro.' >=  '. $inicial. ' and '. $filtro. ' <= '. $final. ' order by valorPassagem';
    }
    $pesquisa = '';
  }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><div class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown" id="paginas"><p class="nav-link">Páginas</p></a><ul class="dropdown-menu" aria-labelledby="paginas"><a class="dropdown -item" href="passagem.php">Passagens Aéreas</a></ul></div></li>
        ...
        <div class="section" id="conteudo">
            ...
            <div class="row container-fluid">
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <h3>Pesquisar</h3>
                    <form method="post" action="passagem.php#conteudo">
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-5 col-lg-7">
                            <select name="filtro" class="custom-select">
                              ...
                              <option value="passageiro" <?php echo $filtro == 'passageiro' ? 'selected ' : ''; ?>>Passageiro</option>
                              <option value="poltrona"  <?php echo $filtro == 'poltrona' ? 'selected ' : ''; ?>>Poltrona</option>
                              <option value="dataVoo" <?php echo $filtro == 'dataVoo' ? 'selected ' : ''; ?>>Data do voo</option>
                              <option value="origem" <?php echo $filtro == 'origem' ? 'selected ' : ''; ?>>Origem</option>
                              <option value="destino" <?php echo $filtro == 'destino' ? 'selected ' : ''; ?>>Destino</option>
                              <option value="valorPassagem" <?php echo $filtro == 'valorPassagem' ? 'selected ' : ''; ?>>Valor da passagem</option>
                            </select>
                        </div>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <select name="filtro" class="custom-select">
                                        <option disabled value="nenhum" <?php echo $filtro == 'nenhum' ? 'selected ' : ''; ?>>Filtro de pesquisa</option>
                                        <option value="origemEDestino" <?php echo $filtro == 'origemEDestino' ? 'selected ' : ''; ?>>Origem e Destino</option>
                                        <option value="valorPassagem" <?php echo $filtro == 'valorPassagem' ? 'selected ' : ''; ?>>Valor Passagem</option>
                                        <option value="dataVoo" <?php echo $filtro == 'dataVoo' ? 'selected ' : ''; ?>>Data do voo</option>
                                      </select>
                    ...
                    <table class="table table-striped table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $tupla['passageiro']; ?></td>
                          <td><?php echo $tupla['poltrona']; ?></td>
                          <td><?php echo converterData($tupla['dataVoo']); ?></td>
                          <td><?php echo $tupla['origem']; ?></td>
                          <td><?php echo $tupla['destino']; ?></td>
                          <td>R$ <?php echo number_format($tupla['valorPassagem'], 2, ',', '.'); ?></td>
                        ...
                        <tr>
                          ...
                          if ($botao == 'buscaAvancada') { ?>
                              <th colspan="5"><th>
                              <th scope="col">Soma das Passagens</th>';
