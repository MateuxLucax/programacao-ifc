...
<?php
  ...
  } elseif ($filtro == 'paciente' || $filtro == 'medico' || $filtro == 'valorConsulta' || $filtro == 'tipoConsulta') {
    $sql = 'select * from '. $tabela. ' where '. $filtro.' like "'. $pesquisa. '%" order by '.$filtro;
  } elseif ($filtro == 'dataConsulta'){
  ...
  } elseif ($filtro == 'medicamento') {
      if ($pesquisa == '') { $sql = 'select * from '. $tabela; }
      elseif($pesquisa == 'sim' || $pesquisa == 'Sim' || $pesquisa == 'SIM' || $pesquisa == 'SiM' || $pesquisa == 'SIm' || $pesquisa == 'sIM' || $pesquisa == 'siM' ) {
        $sql = 'select * from '. $tabela. ' where '. $filtro. ' = true';
      } elseif ($pesquisa == 'naO' || $pesquisa == 'não' || $pesquisa == 'nao' || $pesquisa == 'Não' || $pesquisa == 'NAO' || $pesquisa == 'NAo' || $pesquisa == 'Nao') {
          $sql = 'select * from '. $tabela. ' where '. $filtro. ' = false';
      }
  }
                            ...
                            <table class="table table-striped table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">Medicamento controlado</th>
                                        <th class="text-center" scope="col">Tipo de consulta</th>
                                        <th class="text-center" scope="col">Valor da consulta</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $tupla['paciente']; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['medico']; ?>
                                        </td>
                                        <td>
                                            <?php echo converterData($tupla['dataConsulta']); ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['medicamento'] == true?'Sim':'Não'; ?>
                                        </td>
                                        <td>
                                            <?php echo $tupla['tipoConsulta']; ?>
                                        </td>

                                        <td>R$
                                            <?php echo number_format($tupla['valorConsulta'], 2, ',', '.'); ?>
                                        </td>
                                    ...
                                    <?php 
                                        $somaConsultas += $tupla['valorConsulta'];
                                    } ?>
                                    <tr>
                                        <td colspan="5"></td>
                                        <th class="text-center" scope="col">Soma das consultas</th>
                                        <td>R$ <?php echo number_format($somaConsultas, 2, ',', '.') ?></td>
                                        <td></td>
                                    </tr>
                                </tbody>
                            </table>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-9 col-md-6 col-lg-8">
                                                <select name="filtro" class="custom-select">
                                                    ...
                                                    <option value="paciente" <?php echo $filtro == 'paciente' ? 'selected ' : ''; ?>>Paciente</option>
                                                    <option value="medico" <?php echo $filtro == 'medico' ? 'selected ' : ''; ?>>Médico</option>
                                                    <option value="dataConsulta" <?php echo $filtro == 'dataConsulta' ? 'selected ' : ''; ?>>Data da consulta</option>
                                                    <option value="medicamento" <?php echo $filtro == 'medicamento' ? 'selected ' : ''; ?>>Medicamento controlado</option>
                                                    <option value="tipoConsulta" <?php echo $filtro == 'tipoConsulta' ? 'selected ' : ''; ?>>Tipo da consulta</option>
                                                    <option value="valorConsulta" <?php echo $filtro == 'valorConsulta' ? 'selected ' : ''; ?>>Valor da consulta</option>
                                                </select>
                                            </div>
