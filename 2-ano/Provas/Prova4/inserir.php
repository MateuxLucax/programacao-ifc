              ...
              <form class="form" method="get" action="assets/funcoes/acao.php" style="margin-top: 50%;">
                <div class="card-body">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="paciente" placeholder="Paciente" required="true">
                      <span class="input-group-addon"><i class="now-ui-icons design_app"></i></span>
                    </div>
                    <div class="input-group">
                      <input type="text" class="form-control" name="medico" placeholder="Medico" required="true">
                      <span class="input-group-addon"><i class="now-ui-icons design_app"></i></span>
                    </div>
                    <div class="input-group">
                      <input type="text" class="form-control" name="dataConsulta" placeholder="Data da consulta" required="true">
                      <span class="input-group-addon"><i class="now-ui-icons design_app"></i></span>
                    </div>
                    <h6>Medicamento controlado</h6>
                    <input class="radio" type="radio" value="true" name="medicamento" id="1">
                    <label for="1">Sim</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input class="radio" type="radio" value="false" name="medicamento" id="2" checked="">
                    <label for="2">Não</label>
                    <select name="tipoConsulta" class="custom-select">
                      <option disabled value="nenhum" selected>Tipo da consulta</option>
                    ...
                    <br /><br />
                    <div class="input-group">
                      <input type="number" class="form-control" name="valorConsulta" placeholder="Valor da consulta" step="0.01">
                      <span class="input-group-addon"><i class="now-ui-icons design_app"></i></span>
                    </div>
